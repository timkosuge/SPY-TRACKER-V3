...
═══════════════════════════════════════════════════════ */
function reloadAINarrative()       { window._M && window._M.aiBase(); }
function loadAINarrativeBull()     { window._M && window._M.aiBull(); }
function loadAINarrativeBear()     { window._M && window._M.aiBear(); }
function loadAINarrativeTransition(){ window._M && window._M.aiTransition(); }
...
(function bootMacro() {
  if (document.getElementById('panel-macro')?.classList.contains('active')) {
    setTimeout(() => window._M && window._M.init(), 200);
  }
})();
