...
function _switchPanelOnly(id) {
  ...
  if(id==='gex-intraday') { setTimeout(renderGEXIntradayMap, 50); }
  ...
  el.innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
      ${wem?(()=>{
        ...
        const zLbl  = mktClosed ? 'NEXT SESSION' : Math.abs(z)>1.5?'EXTREME':Math.abs(z)>1?'HIGH':Math.abs(z)>0.5?'ELEVATED':'NORMAL';
      ...
      ${wem?`<div class="panel">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;margin-bottom:10px;">
          <div style="text-align:center;"><div style="font-family:'Orbitron',monospace;font-size:8px;color:#ff3355;">LOW</div><div style="font-family:'Share Tech Mono',monospace;font-size:18px;color:#ff3355;">${_wemLo?'$'+fmt(_wemLo,2):'—'}</div></div>
          <div style="text-align:center;"><div style="font-family:'Orbitron',monospace;font-size:8px;color:var(--text3);">ANCHOR</div><div style="font-family:'Share Tech Mono',monospace;font-size:18px;">${_wemAnchor?'$'+fmt(_wemAnchor,2):'—'}</div></div>
          <div style="text-align:center;"><div style="font-family:'Orbitron',monospace;font-size:8px;color:#00ff88;">HIGH</div><div style="font-family:'Share Tech Mono',monospace;font-size:18px;color:#00ff88;">${_wemHi?'$'+fmt(_wemHi,2):'—'}</div></div>
        </div>
        ${_wemComputed?'<div style="font-size:10px;color:var(--text3);text-align:center;margin-bottom:6px;">estimated from last close · live levels update Mon open</div>':''}
        ${(()=>{
