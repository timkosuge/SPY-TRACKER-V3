  ...
  el.innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
      ${wem?(()=>{
        ...
        // Prefer ATM straddle price from live options chain (most accurate)
        // Falls back to IV formula if straddle not available
        const gexD  = md.gex || {};
        const em    = (gexD.atm_straddle && gexD.atm_straddle > 0)
                      ? gexD.atm_straddle
                      : midP*iv*Math.sqrt(1/365)*0.70;
