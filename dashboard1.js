...
function renderDesk(md,sd){
  ...
  el.innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
      ...
      ${(()=>{ const _wemAnchor=wem.wem_mid||(sd&&sd[0]?.close)||wem.friday_close||cur||0; const _wemIv=wem.atm_iv||wem.static_wem_iv||null; const _wemRng=wem.wem_range||(_wemIv?_wemAnchor*_wemIv*Math.sqrt(6/365)*0.70*2:null); _wemLo=wem.wem_low||(_wemRng?_wemAnchor-_wemRng/2:null); _wemHi=wem.wem_high||(_wemRng?_wemAnchor+_wemRng/2:null); _wemComputed=!wem.wem_low&&_wemLo; return ''; })()}
      ${wem?`<div class="panel">
